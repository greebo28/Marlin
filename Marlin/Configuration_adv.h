 ...
 * ALTS 24-03-06 24-03-28 ???? (future query iems) //#### (TMC configs)
 ...
 */
#define FAN_KICKSTART_TIME  100  // (ms)	//24-03-06
#define FAN_KICKSTART_POWER 180  // 64-255	//24-03-06
...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 }  //24-03-06 (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 5, 5, 0 }       //24-03-06 z was 2 (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 1 }       //24-03-06 Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 0 }    //24-03-04 z was 2 (linear=mm, rotational=°) Backoff from endstops after homing
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 15 }, { 200,  15 }, { 200, 190 }, { 30, 190 } }	//24-03-06
  ...
  #define REPORT_TRAMMING_MM            //24-03-06 Report Z deviation (mm) for each point relative to the first

  #define ASSISTED_TRAMMING_WIZARD      //24-03-06 Add a Tramming Wizard to the LCD menu
...
//#define DISABLE_IDLE_Z    //24-03-06 Disable if the nozzle could fall onto your printed part!
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 5*60, 2*60 } //24-03-06 z was 4*60 (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0	//24-03-06

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, Y_CENTER }	//24-03-06
  #endif
#endif
    ...
    //#define PROBE_DEPLOY_STOW_MENU	//24-03-06
  #endif
  ...
  #define TURBO_BACK_MENU_ITEM	//24-03-06
  ...
  #define STATUS_MESSAGE_SCROLLING	//24-03-06

  // Apply a timeout to low-priority status messages
  //#define STATUS_MESSAGE_TIMEOUT_SEC 60 //24-03-06 was 30 (seconds)
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA	//24-03-06
  ...
  #define LONG_FILENAME_HOST_SUPPORT    //24-03-06 Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES         //24-03-06 Scroll long filenames in the SD card menu
   ...
   */
  #define SDCARD_CONNECTION ONBOARD	//24-03-07 ????
...
#define BABYSTEPPING	//24-03-06
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  8       //24-03-06 was 1 (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 1       // (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    //24-03-06 Double-click on the Status Screen for Z Babystepping.
  ...
  #define BABYSTEP_ZPROBE_OFFSET            //24-03-06 Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE	//24-03-06				
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.04 }    // (mm)24-03-06 was 0.22 Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.4        // (mm) //24-03-06	was 0.22 Compression length applying to all extruders
  #endif
 ...
 */
#define EMERGENCY_PARSER	//24-03-06
 ...
 */
#define ADVANCED_PAUSE_FEATURE	//24-03-06
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         10  //24-03-06 (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE      5  //24-03-06 (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        20  //24-03-06 (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH       50  //24-03-06 (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   5  //24-03-06 (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     0  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   5  //24-03-06 (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH     0  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  //#define ADVANCED_PAUSE_CONTINUOUS_PURGE       // Purge continuously up to the purge length until interrupted.
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        2  //24-03-06 (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  #define ADVANCED_PAUSE_PURGE_LENGTH         40  //24-03-06 (mm) Length to extrude after loading.
                                                  //   Set to 0 for manual extrusion.
                                                  //   Filament can be extruded repeatedly from the Filament Change menu
                                                  //   until extrusion is consistent, and to purge old filament.
  #define ADVANCED_PAUSE_RESUME_PRIME          0  // (mm) Extra distance to prime nozzle after returning from park.
  #define ADVANCED_PAUSE_FANS_PAUSE               //24-03-06 Turn off print-cooling fans while the machine is paused.

                                                  // Filament Unload does a Retract, Delay, and Purge first:
  #define FILAMENT_UNLOAD_PURGE_RETRACT       10  //24-03-06 (mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH         6  //24-03-06 (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      14  //24-03-06 (mm/s) feedrate to purge before unload

  #define PAUSE_PARK_NOZZLE_TIMEOUT           60  //24-03-06 (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                      //24-03-06 Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             //24-03-06 Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       800        //24-03-06 prev 860 (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  //24-03-06 prev 400 (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16        // 0..256
    #define X_RSENSE          0.11		//24-03-06 prev 0.15
    ...
    #define Y_CURRENT       800			//24-03-06 prev 900
    #define Y_CURRENT_HOME  Y_CURRENT	//24-03-06 prev 400
    #define Y_MICROSTEPS     16
    #define Y_RSENSE          0.11		//24-03-06 prev 0.15
    ...
    #define Z_CURRENT       800			//24-03-06 prev 1000
    #define Z_CURRENT_HOME  Z_CURRENT	//24-03-06 prev 400
    #define Z_MICROSTEPS     16
    #define Z_RSENSE          0.11		//24-03-06 prev 0.15
    ...
    #define Z2_CURRENT      Z_CURRENT	24-03-06 prev as Z
    ...
    #define E0_CURRENT      800		//24-03-06 prev 550
    #define E0_MICROSTEPS    16
    #define E0_RSENSE         0.11	//24-03-06 prev 0.15
   ...
   */
  #define  X_SLAVE_ADDRESS 3	//24-03-06 was 0
  #define  Y_SLAVE_ADDRESS 3	//24-03-06 was 0
  #define  Z_SLAVE_ADDRESS 3	//24-03-06 was 0
  ...
  #define E0_SLAVE_ADDRESS 3	//24-03-06 was 0
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        //24-03-06 All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS	//24-03-06
   ...
   */
  #define HYBRID_THRESHOLD	//24-03-06

  #define X_HYBRID_THRESHOLD     180  // [mm/s]//24-03-06 was 100
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     180	//24-03-06 was 100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD      40	//24-03-06 was 3
  ...
  #define E0_HYBRID_THRESHOLD     60	//24-03-06 was 30
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only 24-03-06

  #if ANY(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  65	//24-03-06
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  68	//24-03-06
    ...
    #define IMPROVE_HOMING_RELIABILITY	//24-03-06
  #endif
...
#define CUSTOM_MENU_CONFIG //24-03-28
#if ENABLED(CUSTOM_MENU_CONFIG)
  #define CUSTOM_MENU_CONFIG_TITLE "UBL run items" //24-03-28
  #define CUSTOM_MENU_CONFIG_SCRIPT_DONE "M117 Script Done" //24-03-28
  #define CUSTOM_MENU_CONFIG_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_CONFIG_SCRIPT_RETURN  //24-03-28 Return to status screen after a script
  #define CUSTOM_MENU_CONFIG_ONLY_IDLE        // Only show custom menu when the machine is idle

  #define CONFIG_MENU_ITEM_1_DESC "Textured PEI Slot 0 Tilt" //24-03-28
  #define CONFIG_MENU_ITEM_1_GCODE "G28\nG29 L0\nG29 J\nG0 X1Y5F6000" //24-03-28
  //#define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "Home" //24-03-28
  #define CONFIG_MENU_ITEM_2_GCODE "G28" //24-03-28
 ...
 */
#define HOST_ACTION_COMMANDS	//24-03-06
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                //24-03-06 Tell the host to pause in response to M76
  #define HOST_PROMPT_SUPPORT           //24-03-06 Initiate host prompts to get user feedback
 ...
 */
#define CANCEL_OBJECTS	//24-03-06
 ...
 * @section calibrate
 */
#define MECHANICAL_GANTRY_CALIBRATION	//24-03-06
  ...
  #define GANTRY_CALIBRATION_XY_PARK_FEEDRATE 3000  //24-03-06 XY Park Feedrate - MMM
  #define GANTRY_CALIBRATION_COMMANDS_PRE   "G0 X10 Y125 Z10"	//24-03-06
