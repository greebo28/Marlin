 ...
 * ALTS 24-03-06 2403-11 ???? (future query iems) //#### (TMC configs)
 ...
 */
#define FAN_MIN_PWM 50 //24-03-11
 ...
 */
#define E0_AUTO_FAN_PIN P2_04 //24-03-11
...
#define HOMING_BUMP_MM      { 0, 0, 0 }       //24-03-11 was {5, 5, 2} (linear=mm, rotational=°) Backoff from endstops after first bump
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define STATUS_MESSAGE_TIMEOUT_SEC 60 //24-03-11 was 30 (seconds)
...
#define BABYSTEPPING	//24-03-06
  ...
  #define BABYSTEP_MILLIMETER_UNITS         //24-03-11 Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  0.1     //24-03-11 was 1 (steps or mm) Steps or millimeter distance for each Z babystep
 ...
 */
  ...
  //#define PROBE_PT_1 {  15, 200 }   	//24-03-11 (mm) { x, y } ????
  //#define PROBE_PT_2 {  15,  20 }
  //#define PROBE_PT_3 { 200,  20 }		//24-03-11
#endif
...
// The number of linear moves that can be in the planner at once.
  ...
  #define BLOCK_BUFFER_SIZE  8	//#### try 32
#elif HAS_MEDIA
...
#define TX_BUFFER_SIZE 0	//#### try 32
