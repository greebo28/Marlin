 ...
 * ALTS 24-03-06 24-03-07 (bugfix update 03-08)24-03-10 TMC=24-03-27 ???? ####(future query items)
 * Based on Sprinter and grbl.24
...
#define STRING_CONFIG_H_AUTHOR "(DNCS, sv05 SKR1.4)" // Who made the changes. //24-03-10
 ...
 */
#define BAUDRATE 115200 //24-03-06
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 -1 //24-03-10
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  26.21 //24-03-10
    #define DEFAULT_Ki   2.46 //24-03-10
    #define DEFAULT_Kd  69.80 //24-03-10
  #endif
#else
...
#define PIDTEMPBED //24-03-06
  ...
  #define DEFAULT_bedKp 158.18 //24-03-10
  #define DEFAULT_bedKi  31.27 //24-03-10
  #define DEFAULT_bedKd 533.43 //24-03-10
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         //24-03-06 Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)
  #define PID_AUTOTUNE_MENU     //24-03-06 Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash)
#endif
...
#define EXTRUDE_MINTEMP 180 //24-03-10
/**
 * Prevent a single extrusion longer than EXTRUDE_MAXLENGTH.
 * Note: For Bowden Extruders make this large enough to allow load/unload.
 */
#define PREVENT_LENGTHY_EXTRUDE
#define EXTRUDE_MAXLENGTH 500 //24-03-06
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.72, 79.52, 800, 691.5 } //24-03-06
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 15, 30 } //24-03-06
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      {500, 500, 100, 5000} //24-03-06 was { 3000, 3000, 100, 10000 }
 ...
 */
#define DEFAULT_ACCELERATION          500    //24-03-06 was 3000 X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  500    //24-03-06 was 3000 E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   1000    //24-03-06 was 3000 X, Y, Z acceleration for travel (non printing) moves
...
//#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 10.0	//24-03-06 ???? prev used 8
  #define DEFAULT_YJERK 10.0	//24-03-06 ???? prev used 8
  #define DEFAULT_ZJERK  0.3	//24-03-06 ???? prev used 0.4
 ...
 */
//#define S_CURVE_ACCELERATION //24-03-06 ???? prev enabled 
 ...
 */
//#define Z_MIN_PROBE_PIN PB0_10 //24-03-10
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, 3, -2.396 } //24-03-10
...
#define XY_PROBE_FEEDRATE (60*60) //24-03-06 was (133*60)####
 ...
 */
#define MULTIPLE_PROBING 2 //24-03-06
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE    5 //24-03-10 (mm) Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES  4 //24-03-10 (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     4 //24-03-10 (mm) Z Clearance between multiple probes
#define Z_PROBE_ERROR_TOLERANCE     3 //24-03-10 (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
...
#define Z_MIN_PROBE_REPEATABILITY_TEST //24-03-06
...
//#define PREHEAT_BEFORE_PROBING
  ...
  #define PROBING_NOZZLE_TEMP 150   //24-03-06 (°C) Only applies to E0 at this time
  #define PROBING_BED_TEMP     60	//24-03-06
#endif
...
#define INVERT_E0_DIR true	//24-03-27
...
#define Z_CLEARANCE_FOR_HOMING  10    //24-03-06 was 4 (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
                                      // You'll need this much clearance above Z_MAX_POS to avoid grinding.

#define Z_AFTER_HOMING         10   //24-03-06 (mm) Height to move to after homing (if Z was homed)
#define XY_AFTER_HOMING { 5, 5 }  //24-03-07 (mm) Move to an XY position after homing (and raising Z)
...
#define X_BED_SIZE 235	//24-03-06####
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  //24-03-06 Enable/Disable software endstops from the LCD
#endif
...
#define AUTO_BED_LEVELING_UBL	//24-03-06
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //24-03-10
//#define ENABLE_LEVELING_AFTER_G28

/**
 * Auto-leveling needs preheating
 */
#define PREHEAT_BEFORE_LEVELING	//24-03-06
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION //24-03-10
  #if ENABLED(G26_MESH_VALIDATION)
    #define MESH_TEST_NOZZLE_SIZE    0.4  // (mm) Diameter of primary nozzle.
    #define MESH_TEST_LAYER_HEIGHT   0.3  //24-03-10 (mm) Default layer height for G26.
  ...
  //#define PROBE_Y_FIRST
    ...
    #define EXTRAPOLATE_BEYOND_GRID	//24-03-06
  ...
  #define MESH_INSET 1              //24-03-10#### Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  #define UBL_HILBERT_CURVE       //24-03-06 Use Hilbert distribution for less travel when probing multiple points

  #define UBL_TILT_ON_MESH_POINTS         //24-03-10 Use nearest mesh points with G29 J for better Z reference
  //#define UBL_TILT_ON_MESH_POINTS_3POINT  //24-03-10 Use nearest mesh points with G29 J0 (3-point)

  #define UBL_MESH_EDIT_MOVES_Z     // Sophisticated users prefer no movement of nozzle
  #define UBL_SAVE_ACTIVE_ON_M500   // Save the currently active mesh in the current slot on M500

  #define UBL_Z_RAISE_WHEN_OFF_MESH 2.5 //24-03-10 When the nozzle is off the mesh, this value is used
                                          // as the Z-Height correction value.

  #define UBL_MESH_WIZARD         //24-03-06 Run several commands in a row to get a complete mesh
 ...
 */
#define LCD_BED_LEVELING //24-03-06

#if ENABLED(LCD_BED_LEVELING)
  #define MESH_EDIT_Z_STEP  0.01 //24-03-06 was 0.025 (mm) Step size while manually probing Z axis.
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        //24-03-06 Add a menu to edit mesh points
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING //24-03-10

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 30, 30, 30, 30 } // (mm) Left, Front, Right, Back insets
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at tramming points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between tramming points
  #define BED_TRAMMING_INCLUDE_CENTER       //24-03-10 Move to the center after the last corner
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (7*60) }	//24-03-06#### 06z is 20 Z was 4*60
 ...
 */
//#define SKEW_CORRECTION	//24-03-06

#if ENABLED(SKEW_CORRECTION)
  // Input all length measurements here:
  #define XY_DIAG_AC 99.34		//24-03-06 my SV06 value marlin was 282.8427124746
  #define XY_DIAG_BD 99.2		//24-03-06 my SV06 value marlin was 282.8427124746
  #define XY_SIDE_AD 70.2846	//24-03-06 my SV06 value marlin was 200
 ...
 */
#define EEPROM_SETTINGS      //24-03-06 Persistent storage with M500 and M501
//#define DISABLE_M503        // Saves ~2700 bytes of flash. Disable for release!
#define EEPROM_CHITCHAT       // Give feedback on EEPROM commands. Disable to save flash.
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
#if ENABLED(EEPROM_SETTINGS)
  #define EEPROM_AUTO_INIT    //24-03-06 Init EEPROM automatically on any errors.
...
#define PREHEAT_1_TEMP_HOTEND 205	//24-03-06
#define PREHEAT_1_TEMP_BED     60	//24-03-06
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "PETG"	//24-03-06
#define PREHEAT_2_TEMP_HOTEND 220		//24-03-06
#define PREHEAT_2_TEMP_BED     65		//24-03-10
 ...
 */
#define NOZZLE_PARK_FEATURE	//24-03-06

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 20 } //24-03-10 FRONT RIGHT = (X_MAX_POS - 10), (Y_MAX_POS - 10)
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   2   // (mm) Always raise Z by at least this distance
  #define NOZZLE_PARK_XY_FEEDRATE 200   //24-03-10 (mm/s) X and Y axes feedrate (also used for delta Z axis)
  #define NOZZLE_PARK_Z_FEEDRATE   10   //24-03-10 (mm/s) Z axis feedrate (not used for delta printers)
#endif
 ...
 */
#define SD_CHECK_AND_RETRY //24-03-10
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU	//24-03-06
#define INDIVIDUAL_AXIS_HOMING_SUBMENU	24-03-06
...
//
#define CR10_STOCKDISPLAY	//24-03-06
	 #define RET6_12864_LCD  //24-03-10???? Specific to the SoC (can either be RET / VET)
//
...
// :[0,1,2,3,4,5,6,7]
#define SOFT_PWM_SCALE 5	//24-03-06 was 0
